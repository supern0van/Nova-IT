...
| Kundportalens konto och inloggning     | Ge kunden inloggning för att se och svara på sina egna ärenden   | Kunder med registrerat ärende   | E-post, en tidsbegränsad engångslänk för aktivering/återställning (endast i ett engångsmejl, aldrig loggad - inget lösenord passerar genom våra system, kunden väljer sitt eget när länken löses in), inloggningshistorik | Supabase (databas och autentisering, kundportalens EGET, separata projekt); Cloudflare för drift och säkerhet | [v1.5.2] Kontot tas bort senast 24 månader efter kundens senaste inloggning eller ärendeaktivitet (automatiserad daglig gallring, se `kundportal/lib/admin/kundkonto-gallring.ts` i Nova-IT-Portaler); kan spärras/raderas tidigare på begäran     | [v1.5.2] Berättigat intresse (artikel 6.1 f) - kontot skapas automatiskt utan ett separat val från kunden och är inte ett avtalskrav; kunden kan alltid få hjälp med sitt ärende på annat sätt, t.ex. e-post/telefon |
